...
def download_kaggle_datasets(keyword, target_dir, max_datasets=3):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--target_dir', type=str, default='data_storage/trends', help='Kayıt klasörü')
    parser.add_argument('--max_datasets', type=int, default=3, help='Kaç veri kümesi indirilecek (varsayılan: 3)')
    args = parser.parse_args()
    download_kaggle_datasets(args.keyword, args.target_dir, args.max_datasets) 